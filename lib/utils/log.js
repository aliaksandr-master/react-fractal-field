...
export const logDispatch = (window.console && console.log && console.time && console.group && console.timeEnd && console.groupEnd && process.env.NODE_ENV !== 'production') ? (debugMode = true, store, { type, fieldID, payload }) => {
  if (!debugMode) {
    return () => {};
  }

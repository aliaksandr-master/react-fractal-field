        ...
        if (isFunction(value)) {
          result[key] = (...args) => {
            if (_children.hasChildren) {
              throw new ReferenceError(`invalid usage of control.${key}. this element is container and shouldn't have the control.${key}`);
            }
          ...
          Object.defineProperty(result, key, {
            ...
            get () { // eslint-disable-line fp/no-get-set
              if (_children.hasChildren) {
                throw new ReferenceError(`invalid usage of control.${key}. this element ${that.props.name} is container and shouldn't have the control.${key}`);
              }

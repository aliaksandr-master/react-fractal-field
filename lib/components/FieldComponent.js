...
export default class FieldComponent extends Component {
  ...
  getValue () {
    if (this._postponedValuePreventedVersion !== null) {
  ...
  constructor (...args) {
    ...
    this.provideValueStorage = this.props.hasOwnProperty('value') && (this.props.hasOwnProperty('onChange') || this.props.hasOwnProperty('onValueChange'));
    ...
    if ((this.provideValueStorage && this.provideMetaStorage) || !this.hasParentForm || this.props.isolated) {
      this.share = SHARE.NONE;
    } else if (this.provideValueStorage || this.props.name === null || this.isForm) {
    ...
    this._postponedValuePreventedVersion = null;
  ...
  triggerChange (normalizedValue, { touch = true, notify = true } = {}) {
    if (this.props.postponeInvalid) {
      ...
      if (!isValid) {
        this._postponedValuePreventedVersion = this.getState().valueVersion;
  ...
  _calcParams () {
    if (this._paramsVersion === this.mediator.version() && (this._postponedValuePreventedVersion === null || (this._prevPostponedValue === this._postponedValue))) {
  ...
  componentDidUpdate (prevProps, prevState) {
    ...
    if (this._postponedValuePreventedVersion !== valueVersion) {
      this._postponedValuePreventedVersion = null;
    }

    if (this.provideValueStorage && this.props.value !== prevProps.value) {
      if (this._postponedValuePreventedVersion !== null) {
        this._postponedValuePreventedVersion = null;
      }
  ...
  onUpdate (prevProps) {
    ...
    this.notifyValueOnChange(this.getState().value);

...
export default class FieldComponent extends Component {
  ...
  constructor (...args) {
    ...
    this._prevValidatedValueVersion = -1;
  ...
  validate (value) {
    ...
    if (this._prevValidate === validate && valueVersion === this._prevValidatedValueVersion) {
      flush();

      const meta = this.getMeta();

      return !meta.error && !meta.hasException;
    }
    ...
    try {
      ...
      this._prevValidatedValueVersion = valueVersion;
    } catch (err) {
  ...
  componentDidUpdate (prevProps, prevState) {
    ...
    //if (this.props.onChangeValid && this._prevCheckedValue !== value && meta.valid) {
    //  console.log(value);
    //  this.props.onChangeValid(value);
    //}

    this._prevCheckedValue = value;
